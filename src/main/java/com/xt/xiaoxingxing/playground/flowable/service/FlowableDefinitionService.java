...
public class FlowableDefinitionService {
    ...
    public List<FlowableProcessDefinitionVO> listProcessDefinitions() {
    ...
    public List<FlowableDecisionDefinitionVO> listDecisionDefinitions() {
    ...
    public LeaveRouteVO evaluate(LeaveRouteEvaluateRequest request) {
    ...
    public LeaveRouteVO evaluate(Integer leaveDays, String leaveType) {
        return evaluate(leaveDays, leaveType, null, null, null);
    }

    /** 在 BPMN 服务任务内执行 DMN，并把执行上下文写入 DMN 历史。 */
    public LeaveRouteVO evaluateForProcess(Integer leaveDays, String leaveType,
    ...
    private LeaveRouteVO evaluate(Integer leaveDays, String leaveType,
                                  String instanceId, String executionId, String activityId) {
        ...
        LeaveRouteVO view = new LeaveRouteVO();
    ...
    private FlowableProcessDefinitionVO toView(ProcessDefinition source) {
        FlowableProcessDefinitionVO view = new FlowableProcessDefinitionVO();
    ...
    private FlowableDecisionDefinitionVO toDefinitionView(DmnDecision source) {
        FlowableDecisionDefinitionVO view = new FlowableDecisionDefinitionVO();
        view.setId(source.getId());
        view.setKey(source.getKey());
        view.setName(source.getName());
        view.setVersion(source.getVersion());
