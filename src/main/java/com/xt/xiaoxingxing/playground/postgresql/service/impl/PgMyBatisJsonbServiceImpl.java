...
import com.xt.xiaoxingxing.playground.postgresql.mapper.PgMyBatisProductMapper;
import com.xt.xiaoxingxing.playground.postgresql.mapper.PgMyBatisProductProfileMapper;
...
public class PgMyBatisJsonbServiceImpl implements PgJsonbService {
    ...
    public PgProductProfile getById(Long id) {
        ...
        return BusinessAssert.notNull(profileMapper.selectProfileById(id), "商品扩展信息不存在");
    }

    @Override
    public List<PgProductProfile> list() {
        return profileMapper.selectAllProfiles();
    }
    ...
    public List<PgProductProfile> search(ProductProfileSearchRequest request) {
        ...
        return profileMapper.selectProfilesByCondition(normalized);
    }
