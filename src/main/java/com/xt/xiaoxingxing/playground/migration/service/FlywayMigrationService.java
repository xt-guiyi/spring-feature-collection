package com.xt.xiaoxingxing.playground.migration.service;
...
public class FlywayMigrationService {
    ...
    /** 查询当前 Flyway 迁移概览。 */
    public MigrationStatusVO status() {
    ...
    public List<MigrationHistoryVO> history() {
        MigrationInfoService infoService = flyway.info();
    ...
    private MigrationHistoryVO toHistory(MigrationInfo source) {
        MigrationHistoryVO target = new MigrationHistoryVO();
