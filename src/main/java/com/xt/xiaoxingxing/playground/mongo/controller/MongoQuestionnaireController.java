...
public class MongoQuestionnaireController {
    ...
    /** 创建一个没有题目的 DRAFT 问卷。 */
    @PostMapping
    public Result<QuestionnaireVO> create(@Valid @RequestBody QuestionnaireCreateRequest request) {
        return Result.ok(questionnaireService.create(request));
    }

    /** 查询问卷详情，并在 Service 中联动 PostgreSQL users 表补充创建人信息。 */
    @GetMapping("/{id}")
    public Result<QuestionnaireVO> getById(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public Result<QuestionnaireVO> update(
    ...
    public Result<QuestionnaireVO> addQuestion(
            @PathVariable String id,
            @RequestParam @PositiveOrZero long expectedVersion,
    ...
    public Result<QuestionnaireVO> updateQuestion(
            @PathVariable String id,
    ...
    public Result<QuestionnaireVO> deleteQuestion(
            @PathVariable String id,
            @PathVariable String questionId,
            @RequestParam @PositiveOrZero long expectedVersion) {
    ...
    public Result<QuestionnaireVO> publish(
            @PathVariable String id,
            @RequestParam @PositiveOrZero long expectedVersion) {
    ...
    public Result<QuestionnaireVO> close(
            @PathVariable String id,
            @RequestParam @PositiveOrZero long expectedVersion) {
    ...
    public Result<QuestionnaireStatisticsVO> statistics(@PathVariable String id) {
