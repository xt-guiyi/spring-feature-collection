...
import com.xt.xiaoxingxing.playground.features.elasticsearch.repository.ArticleRepository;
import com.xt.xiaoxingxing.playground.features.elasticsearch.service.ArticleCrudService;
...
public class SpringDataArticleCrudService implements ArticleCrudService {
    ...
    @Override
    public ArticleDetailResponse create(ArticleWriteRequest request) {
    ...
    @Override
    public ArticleDetailResponse getById(String id) {
        articleIndexGuard.requireAlias();
    ...
    @Override
    public ArticleDetailResponse update(String id, ArticleWriteRequest request) {
        articleIndexGuard.requireAlias();
