...
import com.xt.xiaoxingxing.playground.features.elasticsearch.dto.response.ArticleBulkResultResponse;
import com.xt.xiaoxingxing.playground.features.elasticsearch.dto.response.ArticleIndexStatusResponse;
import com.xt.xiaoxingxing.playground.features.elasticsearch.dto.response.ArticleRebuildResponse;
import com.xt.xiaoxingxing.playground.features.elasticsearch.support.ArticleRequestValidator;
import com.xt.xiaoxingxing.playground.features.elasticsearch.support.ArticleSeedData;
...
public class ArticleIndexManager {
     ...
     */
    public ArticleIndexStatusResponse initialize() {
        try {
            if (aliasExists()) {
                return status();
            }
    ...
    public ArticleBulkResultResponse seed() {
        try {
            ...
            ArticleBulkResultResponse result = new ArticleBulkResultResponse();
    ...
    public ArticleIndexStatusResponse status() {
        try {
            ...
            ArticleIndexStatusResponse result = new ArticleIndexStatusResponse();
    ...
    public ArticleRebuildResponse rebuild() {
        try {
            AliasState aliasState = aliasState();
            ...
            ArticleRebuildResponse result = new ArticleRebuildResponse();
            result.setAlias(ElasticsearchConstants.INDEX_ALIAS);
