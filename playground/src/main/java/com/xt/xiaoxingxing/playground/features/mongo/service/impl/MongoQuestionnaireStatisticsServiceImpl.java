...
import com.xt.xiaoxingxing.playground.features.mongo.dto.response.QuestionStatisticResponse;
...
public class MongoQuestionnaireStatisticsServiceImpl implements MongoQuestionnaireStatisticsService {
    ...
    @Override
    public QuestionnaireStatisticsResponse statistics(String questionnaireId) {
        /*
         * 实现步骤：
        ...
        List<QuestionStatisticResponse> questionResults = questionnaire.getQuestions().stream()
                .map(question -> toStatistic(question, answeredCounts, optionCounts, numericStatistics))
                .toList();

        QuestionnaireStatisticsResponse result = new QuestionnaireStatisticsResponse();
    ...
    private QuestionStatisticResponse toStatistic(QuestionDefinition question,
                                            Map<String, Long> answeredCounts,
                                            Map<String, Map<String, Long>> optionCounts,
                                            Map<String, NumericStatistics> numericStatistics) {
        QuestionStatisticResponse result = new QuestionStatisticResponse();
