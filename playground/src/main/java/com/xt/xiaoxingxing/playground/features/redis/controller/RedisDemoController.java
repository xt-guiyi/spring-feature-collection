package com.xt.xiaoxingxing.playground.features.redis.controller;

import com.xt.xiaoxingxing.playground.features.redis.dto.request.*;
...
public class RedisDemoController {
     ...
     */
    @PostMapping("/object")
    public Result<RedisDemoResponse> setObject(@RequestBody RedisDemoRequest request) {
        return Result.ok(redisDemoService.setObject(request));
    }
     ...
     */
    @GetMapping("/object")
    public Result<RedisDemoResponse> getObject(@RequestParam String key) {
    ...
    public Result<RedisDistanceResponse> distanceGeo(@RequestParam String key,
                                        @RequestParam String member1,
                                        @RequestParam String member2) {
        return Result.ok(redisDemoService.distanceGeo(key, member1, member2));
    }
     ...
     */
    @PostMapping("/stream")
    public Result<RedisRecordIdResponse> addStream(@Valid @RequestBody RedisStreamRequest request) {
     ...
     */
    @GetMapping("/stream")
    public Result<List<RedisStreamRecordResponse>> readStream(@RequestParam String key) {
