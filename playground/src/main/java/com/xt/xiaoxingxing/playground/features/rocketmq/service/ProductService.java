...
public class ProductService {
    ...
    private ProductResponse toResponse(Product source, boolean cacheHit) {
        return new ProductResponse(source.getId(), source.getName(), source.getPrice(),
                source.getStock(), cacheHit);
    }
